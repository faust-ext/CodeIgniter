<form method="POST" name="form4" id="form4" action="/pamm/dsp/rejoin_submit/<?php echo $acc_number?>">
...
<?php if ($not_enough_sum)
	...
	<a class="submit" href="/pamm/dsp/invest"><span style="color:white;font-weight:bold;">Cancel</span></a></td><td><a class="submit" href="#" onClick="form4submit(<?php echo $wallet['USD']?>,<?php echo $wallet['EUR']?>,<?php echo $wallet['GBP']?>,<?php echo $wallet['JPY']?>,<?php echo $wallet['CHF']?>,<?php echo $wallet['TRY']?>,<?php echo $wallet['RUR']?>);"><span style="color:white;font-weight:bold;">Charge</span></a>
	</td></tr></table>
	</form>
	<?php
	}
