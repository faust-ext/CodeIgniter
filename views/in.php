<form method="POST" name="form2" id="form2" action="/pamm/dsp/in_submit/<?php echo $acc_number;?>">
<table><tr><td>
...
<a class="submit" href="/pamm/dsp/inout/<?php echo $acc_number?>"><span style="color:white;font-weight:bold;">Cancel</span></a></td><td><a class="submit" href="#" onClick="form2submit(<?php echo $wallet['USD']?>,<?php echo $wallet['EUR']?>,<?php echo $wallet['GBP']?>,<?php echo $wallet['JPY']?>,<?php echo $wallet['CHF']?>,<?php echo $wallet['TRY']?>,<?php echo $wallet['RUR']?>);"><span style="color:white;font-weight:bold;">Charge</span></a>
</td></tr></table>
</form>