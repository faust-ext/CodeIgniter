			 ...
			 if ($value->cmd == 'Buy ')
				...
				elseif (substr(trim($value->comment),0,13) == 'join investor')
				{
					 ...
					 $inv[$count_inv]['active'] = 1;
							 if (trim(substr($value->comment,14)) == $this->session->userdata('TRADER_ID'))
								 $printstr ="<tr><td>".$value->order."</td><td style='padding-left:5px;'>".date('d-m-Y h:i:s',$value->open_time)."</td><td style='padding-left:5px;'>".$value->cmd."</td><td colspan='9' align='right'>Join deposit investor ".trim(substr($value->comment,14))."</td><td style='padding-left:25px;text-align:right;'>".number_format($value->profit,2, '.', '')."</td></tr>";
							 else
				...
				elseif (substr(trim($value->comment),0,16) == 'unjoint investor')
				{
					...
					foreach ($inv as $key2=>$value2)
					{
					 ...
					 $key_unjoint = $key_s;
					 if (substr($value->comment,17) == $this->session->userdata('TRADER_ID'))
						 $printstr ="<tr><td>".$value->order."</td><td style='padding-left:5px;'>".date('d-m-Y h:i:s',$value->open_time)."</td><td style='padding-left:5px;'>".$value->cmd."</td><td colspan='9' align='right'>Unjoint deposit investor ".$this->session->userdata('TRADER_ID')."</td><td style='padding-left:25px;text-align:right;'>".number_format($value->profit,2, '.', '')."</td></tr>";
					 else
				...
				elseif (substr(trim($value->comment),0,15) == 'rejoin investor')
				{
					...
					foreach ($inv as $key2=>$value2)
					{
					 ...
					 if (substr(trim($value->comment),0,15) == $this->session->userdata('TRADER_ID'))
						 $printstr ="<tr><td>".$value->order."</td><td style='padding-left:5px;'>".date('d-m-Y h:i:s',$value->open_time)."</td><td style='padding-left:5px;'>".$value->cmd."</td><td colspan='9' align='right'>Rejoin investor ".$this->session->userdata('TRADER_ID')."</td><td style='padding-left:25px;text-align:right;'>".number_format($value->profit,2, '.', '')."</td></tr>";
					 else
				...
				elseif (substr(trim($value->comment),0,11) == 'wd investor')
				{
					 ...
					 $balance_account = $balance_account + $value->profit;
					 if (trim(substr($value->comment,12)) == $this->session->userdata('TRADER_ID'))
						 $printstr ="<tr><td>".$value->order."</td><td style='padding-left:5px;'>".date('d-m-Y h:i:s',$value->open_time)."</td><td style='padding-left:5px;'>".$value->cmd."</td><td colspan='9' align='right'>Withdraw deposit investor ".$this->session->userdata('TRADER_ID')."</td><td style='padding-left:25px;text-align:right;'>".number_format($value->profit,2, '.', '')."</td></tr>";
					 else
				...
				elseif (substr(trim($value->comment),0,16) == 'deposit investor')
				{
					 ...
					 $balance_account = $balance_account + $value->profit;
					 if (trim(substr($value->comment,17)) == $this->session->userdata('TRADER_ID'))
						 $printstr ="<tr><td>".$value->order."</td><td style='padding-left:5px;'>".date('d-m-Y h:i:s',$value->open_time)."</td><td style='padding-left:5px;'>".$value->cmd."</td><td colspan='9' align='right'>Charge deposit investor ".$this->session->userdata('TRADER_ID')."</td><td style='padding-left:25px;text-align:right;'>".number_format($value->profit,2, '.', '')."</td></tr>";
					 else
				...
				elseif (substr(trim($value->comment),0,26) == 'urgent commission investor')
				{
					 ...
					 $balance_account = $balance_account + $value->profit;
					 if (trim(substr($value->comment,27)) == $this->session->userdata('TRADER_ID'))
						 $printstr ="<tr><td>".$value->order."</td><td style='padding-left:5px;'>".date('d-m-Y h:i:s',$value->open_time)."</td><td style='padding-left:5px;'>".$value->cmd."</td><td colspan='9' align='right'>Urgent commission wd investor ".$this->session->userdata('TRADER_ID')."</td><td style='padding-left:25px;text-align:right;'>".number_format($value->profit,2, '.', '')."</td></tr>";
					 else
				...
				elseif (substr(trim($value->comment),0,18) == 'urgent wd investor')
				{
					 ...
					 $balance_account = $balance_account + $value->profit;
					 if (substr(trim($value->comment),19,2) == $this->session->userdata('TRADER_ID'))
						 $printstr ="<tr><td>".$value->order."</td><td style='padding-left:5px;'>".date('d-m-Y h:i:s',$value->open_time)."</td><td style='padding-left:5px;'>".$value->cmd."</td><td colspan='9' align='right'>Urgent wd investor ".$this->session->userdata('TRADER_ID')."</td><td style='padding-left:25px;text-align:right;'>".number_format($value->profit,2, '.', '')."</td></tr>";
					 else
				...
				elseif (substr(trim($value->comment),0,18) == 'wd profit investor')
				{
					 ...
					 $balance_account = $balance_account + $value->profit;
					 if (substr(trim($value->comment),19,2) == $this->session->userdata('TRADER_ID'))
						 $printstr ="<tr><td>".$value->order."</td><td style='padding-left:5px;'>".date('d-m-Y h:i:s',$value->open_time)."</td><td style='padding-left:5px;'>".$value->cmd."</td><td colspan='9' align='right'>Withdraw deposit investor ".$this->session->userdata('TRADER_ID')."</td><td style='text-align:right;padding-left:25px;text-align:right;'>".number_format($value->profit,2, '.', '')."</td></tr>";
					 else
				...
				elseif (substr(trim($value->comment),0,22) == "close account investor")
				{
					 ...
					 $balance_account = $balance_account + $value->profit;
					 if (substr(trim($value->comment),23,2) == $this->session->userdata('TRADER_ID'))
						 $printstr ="<tr><td>".$value->order."</td><td style='padding-left:5px;'>".date('d-m-Y h:i:s',$value->open_time)."</td><td style='padding-left:5px;'>".$value->cmd."</td><td colspan='9' align='right'>close account investor ".$this->session->userdata('TRADER_ID')." wd</td><td style='text-align:right;padding-left:25px;text-align:right;'>".number_format($value->profit,2, '.', '')."</td></tr>";
					 else
...

				{
					...
					if (count($inv)>0)
							...
							if ($inv[$key1]['active'] == 1)
							   if ($inv[$key1]['number'] == $this->session->userdata('TRADER_ID'))
								print("<tr><td colspan='12' align='right'><b>Investor ".$this->session->userdata('TRADER_ID')." profit:</b></td><td style='padding-left:25px;text-align:right;'>0.00</td></tr>");
							   else
				...
				elseif (trim($value->comment) == 'div loss v2')
				{
					...
					print("<tr><td colspan='12' align='right'><b>Total profit at the end of the trading period:</b></td><td style='padding-left:25px;text-align:right;'>".color(number_format((0-$value->profit),2, '.', ''))."</td></tr>");
						...
						foreach ($inv as $key1=>$value1)
							...
							if ($inv[$key1]['active'] == 1)
							   if ($inv[$key1]['number'] == $this->session->userdata('TRADER_ID'))
								print("<tr><td colspan='12' align='right'><b>Investor ".$this->session->userdata('TRADER_ID')." profit:</b></td><td style='padding-left:25px;text-align:right;'>".color(number_format($statement[$key_new]->profit,2, '.', ''))."</td></tr>");
							   else
					...
					$key_new = $key_new+1;
						foreach ($inv as $key1=>$value1)
							...
							if ($inv[$key1]['active'] == 1)
							  {
							   if ($inv[$key1]['number'] == $this->session->userdata('TRADER_ID'))
								print("<tr><td colspan='12' align='right'><b>Investor ".$this->session->userdata('TRADER_ID')." profit:</b></td><td style='padding-left:25px;text-align:right;'>".color(number_format($n->profit,2, '.', ''))."</td></tr>");
							   else
				...
				elseif (trim($value->comment) == 'div profit v3')
				{
					...
					else
					{
						...
						foreach ($inv as $key1=>$value1)
							...
							if ($inv[$key1]['active'] == 1)
							   if ($inv[$key1]['number'] == $this->session->userdata('TRADER_ID'))
								print("<tr><td colspan='12' align='right'><b>Investor ".$this->session->userdata('TRADER_ID')." refund:</b></td><td style='padding-left:25px;text-align:right;'>".color(number_format($n->profit,2, '.', ''))."</td></tr>");
							   else
