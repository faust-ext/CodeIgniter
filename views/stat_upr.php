			 ...
			 if ($value->cmd == 'Buy ')
				...
				elseif (substr(trim($value->comment),0,16) == 'unjoint investor')
				{
					...
					foreach ($inv as $key2=>$value2)
					{
					 ...
					 $printstr ="<tr><td>".$value->order."</td><td style='padding-left:5px;'>".date('d-m-Y h:i:s',$value->open_time)."</td><td style='padding-left:5px;'>".$value->cmd."</td><td colspan='9' align='right'>Unjoint deposit investor ".trim(substr($value->comment,17))."</td><td style='padding-left:25px;text-align:right;'>".number_format($value->profit,2, '.', '')."</td></tr>";
					 $balance_account = $balance_account + $value->profit;
					 $deposit = $deposit + $value->profit;
				}
				elseif (substr(trim($value->comment),0,15) == 'rejoin investor')
				{
					foreach ($inv as $key2=>$value2)
					{
					 ...
					 $printstr ="<tr><td>".$value->order."</td><td style='padding-left:5px;'>".date('d-m-Y h:i:s',$value->open_time)."</td><td style='padding-left:5px;'>".$value->cmd."</td><td colspan='9' align='right'>Rejoin investor ".trim(substr(trim($value->comment),16))."</td><td style='padding-left:25px;text-align:right;'>".number_format($value->profit,2, '.', '')."</td></tr>";
					 $balance_account = $balance_account + $value->profit;
					 $deposit = $deposit + $value->profit;
					 $count_inv++;
				...
				{
					 $balance_account = $balance_account + $value->profit;
					 $printstr ="<tr><td>".$value->order."</td><td style='padding-left:5px;'>".date('d-m-Y h:i:s',$value->open_time)."</td><td style='padding-left:5px;'>".$value->cmd."</td><td colspan='9' align='right'>Withdraw deposit investor ".trim(substr($value->comment,12))."</td><td style='padding-left:25px;text-align:right;'>".number_format($value->profit,2, '.', '')."</td></tr>";
					 $deposit = $deposit + $value->profit;
				}
				elseif (substr(trim($value->comment),0,16) == 'deposit investor')
				{
					 $balance_account = $balance_account + $value->profit;
					 $printstr ="<tr><td>".$value->order."</td><td style='padding-left:5px;'>".date('d-m-Y h:i:s',$value->open_time)."</td><td style='padding-left:5px;'>".$value->cmd."</td><td colspan='9' align='right'>Charge deposit investor ".trim(substr($value->comment,17))."</td><td style='padding-left:25px;text-align:right;'>".number_format($value->profit,2, '.', '')."</td></tr>";
					 $deposit = $deposit + $value->profit;
				}
				elseif (substr(trim($value->comment),0,26) == 'urgent commission investor')
				{
					 $balance_account = $balance_account + $value->profit;
					 $printstr ="<tr><td>".$value->order."</td><td style='padding-left:5px;'>".date('d-m-Y h:i:s',$value->open_time)."</td><td style='padding-left:5px;'>".$value->cmd."</td><td colspan='9' align='right'>Urgent commission wd investor ".trim(substr($value->comment,27))."</td><td style='padding-left:25px;text-align:right;'>".number_format($value->profit,2, '.', '')."</td></tr>";
					 $deposit = $deposit + $value->profit;
				}
				elseif (substr(trim($value->comment),0,18) == 'urgent wd investor')
				{
					 $balance_account = $balance_account + $value->profit;
					 $printstr ="<tr><td>".$value->order."</td><td style='padding-left:5px;'>".date('d-m-Y h:i:s',$value->open_time)."</td><td style='padding-left:5px;'>".$value->cmd."</td><td colspan='9' align='right'>Urgent wd investor ".substr(trim($value->comment),19,2)."</td><td style='padding-left:25px;text-align:right;'>".number_format($value->profit,2, '.', '')."</td></tr>";
					 $deposit = $deposit + $value->profit;
				}
				...
				elseif (substr(trim($value->comment),0,22) == "close account investor")
				{
					 ...
					 $balance_account = $balance_account + $value->profit;
					 $printstr ="<tr><td>".$value->order."</td><td style='padding-left:5px;'>".date('d-m-Y h:i:s',$value->open_time)."</td><td style='padding-left:5px;'>".$value->cmd."</td><td colspan='9' align='right'>close account investor ".substr(trim($value->comment),23,2)." wd</td><td style='text-align:right;padding-left:25px;text-align:right;'>".number_format($value->profit,2, '.', '')."</td></tr>";
...

				{
					...
					if (count($inv)>0)
							...
							if ($inv[$key1]['active'] == 1)
								print("<tr><td colspan='12' align='right'><b>Investor ".$inv[$key1]['number']." profit:</b></td><td style='padding-left:25px;text-align:right;'>0.00</td></tr>");
							}
					...
					print("<tr><td colspan='12' align='right'><b>Total profit at the end of the trading period:</b></td><td style='padding-left:25px;text-align:right;'>".color(number_format((0-$value->profit),2, '.', ''))."</td></tr>");
						...
						foreach ($inv as $key1=>$value1)
							...
							if ($inv[$key1]['active'] == 1)
								...
								print("<tr><td colspan='12' align='right'><b>Investor ".$inv[$key1]['number']." profit:</b></td><td style='padding-left:25px;text-align:right;'>".color(number_format($statement[$key_new]->profit,2, '.', ''))."</td></tr>");
							}
					print("<tr><td colspan='12' align='right'><b>Balance:</b></td><td style='padding-left:25px;text-align:right;'>".number_format($balance_account,2, '.', '')."</td></tr>");
					print("<tr><td colspan='13'>&nbsp;</td></tr>");
					}
				...
				elseif (trim($value->comment) == 'div profit v42')
				{
					...
					$key_new = $key_new+1;
						foreach ($inv as $key1=>$value1)
							...
							if ($inv[$key1]['active'] == 1)
							    {
								print("<tr><td colspan='12' align='right'><b>Investor ".$inv[$key1]['number']." profit:</b></td><td style='padding-left:25px;text-align:right;'>".color(number_format($n->profit,2, '.', ''))."</td></tr>");
							    }
							else
								$key_new = $key_new - 1;
							}
				...
				elseif (trim($value->comment) == 'div profit v3')
				{
					...
					else
					{
						...
						foreach ($inv as $key1=>$value1)
							...
							$key_print = $key1 + 1;
							if ($inv[$key1]['active'] == 1)
								print("<tr><td colspan='12' align='right'><b>Investor ".$inv[$key1]['number']." refund:</b></td><td style='padding-left:25px;text-align:right;'>".color(number_format($statement[$key_new]->profit,2, '.', ''))."</td></tr>");
							else
								$key_new = $key_new - 1;
							}
						print("<tr><td colspan='12' align='right'><b>Balance:</b></td><td style='padding-left:25px;text-align:right;'>".number_format($balance_account,2, '.', '')."</td></tr>");
				...
				elseif (trim($value->comment) == 'div profit v41')
				{
					...
					$key_new = $key_new+1;
						foreach ($inv as $key1=>$value1)
							...
							$key_print = $key1 + 1;
							if ($inv[$key1]['active'] == 1)
								print("<tr><td colspan='12' align='right'><b>Investor ".$inv[$key1]['number']." refund:</b></td><td style='padding-left:25px;text-align:right;'>".color(number_format($n->profit,2, '.', ''))."</td></tr>");
							else
								$key_new = $key_new - 1;
							}
