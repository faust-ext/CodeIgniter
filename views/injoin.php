<form method="POST" name="form5" id="form5" action="/pamm/dsp/injoin_submit/<?php echo $acc_number?>">
<table><tr><td>
...
<a class="submit" href="/pamm/dsp/invest"><span style="color:white;font-weight:bold;">Cancel</span></a></td><td><a class="submit" href="#" onClick="form5submit(<?php echo $wallet['USD']?>,<?php echo $wallet['EUR']?>,<?php echo $wallet['GBP']?>,<?php echo $wallet['JPY']?>,<?php echo $wallet['CHF']?>,<?php echo $wallet['TRY']?>,<?php echo $wallet['RUR']?>);"><span style="color:white;font-weight:bold;">Charge</span></a>
</td></tr></table>
</form>